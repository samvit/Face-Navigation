...
public class FaceRecognition {
  ...
  public void learn(final String trainingFileName) {
    ...
    // load training data
    System.out.println("===========================================");
    System.out.println("Loading the training images in " + trainingFileName);
    trainingFaceImgArr = loadFaceImgArray(trainingFileName);
    nTrainFaces = trainingFaceImgArr.length;
    System.out.println("Got " + nTrainFaces + " training images");
    if (nTrainFaces < 3) {
      System.err.println("Need 3 or more training faces\n"
...
//    }
  ...
  private CvMat loadTrainingData() {
    ...
    fileStorage = cvOpenFileStorage(
            ...
            null); // encoding
    if (fileStorage == null) {
      System.err.println("Can't open training database file 'data/facedata.xml'.");
      return null;
    }
    ...
    nPersons = cvReadIntByName(
            ...
            0); // default_value
    if (nPersons == 0) {
      System.err.println("No people found in the training database 'data/facedata.xml'.");
      return null;
    } else {
